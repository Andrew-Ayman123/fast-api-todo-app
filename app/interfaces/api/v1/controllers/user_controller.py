...
from app.dependencies import get_user_service, get_jwt_service
...
async def register_user(
    ...
    try:
        ...
        user_response = UserResponseWithToken(**_convert_user_to_response(user).model_dump(), token=token)
...
async def login_user(
    ...
    try:
        ...
        user_response = UserResponseWithToken(**_convert_user_to_response(user).model_dump(), token=token)
        return user_response
    except WrongEmailOrPasswordException as e:
