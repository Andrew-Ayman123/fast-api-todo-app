...
class TestEnvUtils:
    ...
    def test_get_env_with_none_value(self):
    ...
    def test_get_env_int_with_default_value(self):
    ...
    def test_get_env_bool_with_true_string(self):
    ...
    def test_get_env_int_with_invalid_string_should_raise_error(self):
    ...
    def test_get_env_int_with_float_string_should_raise_error(self):
